...
/// </param name>
/// <summary>
/// checks if the index is outside of the array. If it is. It'll have a runtime error
/// </summary> 
/// <returns>
/// the index
/// </returns>
...
/// </param name>
/// <summary>
/// checks if the index is outside of the array. If it is. It'll give you the error message 
/// </summary> 
/// <returns>
/// the index
/// </returns>
...
/// </param name>
/// <summary>
/// checks if the index is outside of the array. If it is. It'll return None
/// </summary> 
/// <returns>
/// An option
/// </returns>
